...
answer = input("What class do you want to be?  (F = Human Fighter, W = Human Wizzard, R = Dwarf Rogue)")
...
story = """You are teleported to the entrance of a large tower.
...
if answer == "U":
    ...
    if answer == "A":
        ...
        if attack == "R":
            ...
            if Class == "W":
                roll = input("Roll a D-6 and enter it here")
            elif Class == "R" or Class == "F":
                roll = input("Roll a D-8 and enter it here")
            print("Excellent! You killed a rat and gained +25XP")
            xp += 25
        print("You continue up the stairs")
    elif answer == "R":
        print("You Ran Away from the Rat Continuing up the stairs")
    ...
    if dead == False:
        ...
        # you gain a level and 2 proficiency points if your xp is greater than 300
        if xp > 300:
